...
function App() {
  ...
  return (
    <div className = 'main'>
      ...
      <header>
       ...
       <div className = "navRight">
        <h2 className = "nav" onClick = {() => window.open('../Files/ArettiMenu.pdf', '_blank')}>Menu</h2>
        <h2 className = "nav" onClick={scrollToLocation}>Our Location </h2>
    ...
    <div className = "thirds2">
      <div className = "end" ref={locationRef}></div>
      <div className = "end2">
